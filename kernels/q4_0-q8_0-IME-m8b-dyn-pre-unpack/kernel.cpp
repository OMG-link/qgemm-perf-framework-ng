...
void SQ4BitGemmM8Kernel_CompInt8_ScaleFp16_Impl_Intrin_BatchRed_DynPreUnpack(const int8_t *GGML_RESTRICT baseAQs, const float *GGML_RESTRICT baseAScales, const int8_t *GGML_RESTRICT baseWQs,
                                                                             const uint16_t *GGML_RESTRICT baseWScales, float *GGML_RESTRICT baseC, size_t CountN, size_t BlockCountK,
                                                                             const size_t ldc) {
