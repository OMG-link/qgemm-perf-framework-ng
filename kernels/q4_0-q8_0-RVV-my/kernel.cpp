...
// m: m
// n: n
void ggml_gemm_q4_0_8x32_q8_0(int k, float *GGML_RESTRICT s, size_t bs, const void *GGML_RESTRICT vx, const void *GGML_RESTRICT vy, int m, int n) {
    ...
    const block_q8_0_rvv_m8 *a_ptr_start = (const block_q8_0_rvv_m8 *)vy;
    ...
    for (int y = 0; y < anr / mrr; y++) { // M
        ...
        const block_q8_0_rvv_m8 *a_ptr = a_ptr_start + (y * nb);
