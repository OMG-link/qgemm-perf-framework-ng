...
// m: m
// n: n
void ggml_gemm_q4_0_12x32_q8_0(int k, float *GGML_RESTRICT s, size_t bs, const void *GGML_RESTRICT vx, const void *GGML_RESTRICT vy, int m, int n) {
    const int nb = k / QK4_0;
    [[maybe_unused]] const int ncols_interleaved = 32;
        ...
        for (int x = 0; x < n / nrr; x++) { // N
            ...
            for (int64_t b = 0; b < nb; b++) { // K
                ...
                // 内核贡献 1.5
                {
                    ...
                    src0_0 = __riscv_vle8_v_u8m1(reinterpret_cast<const uint8_t *>(b_ptr[b].qs + z * nrr), vl);
                    src0_0_prefetch = __riscv_vle8_v_u8m1(reinterpret_cast<const uint8_t *>(b_ptr[b].qs + (z + 1) * nrr), vl);
                    vint8m1_t low4bits_0 = __riscv_vsub_vx_i8m1(__riscv_vreinterpret_v_u8m1_i8m1(__riscv_vand_vx_u8m1(src0_0, 0x0F, vl)), 8, vl);
                    ...
                    low4bits_0 = __riscv_vsub_vx_i8m1(__riscv_vreinterpret_v_u8m1_i8m1(__riscv_vsrl_vx_u8m1(src0_0, 4, vl)), 8, vl);
                ...
                vfloat32m4_t vec_scales_32 = __riscv_vfwcvt_f_f_v_f32m4(__riscv_vle16_v_f16m2(b_ptr[b].d, vl), vl);

                //先将sum结果与q4的d相乘，再与q8的d相乘
                __riscv_vse32_v_f32m4(sum_row,
                                      __riscv_vfmacc_vv_f32m4(__riscv_vle32_v_f32m4(sum_row, vl), __riscv_vfwcvt_f_x_v_f32m4(suml_32_0, vl),
                                                              __riscv_vfmul_vf_f32m4(vec_scales_32, static_cast<float>(a_ptr[b].d[0]), vl), vl),
                                      vl);
                __riscv_vse32_v_f32m4(sum_row + nrr,
                                      __riscv_vfmacc_vv_f32m4(__riscv_vle32_v_f32m4(sum_row + nrr, vl), __riscv_vfwcvt_f_x_v_f32m4(suml_32_1, vl),
                                                              __riscv_vfmul_vf_f32m4(vec_scales_32, static_cast<float>(a_ptr[b].d[1]), vl), vl),
                                      vl);
                __riscv_vse32_v_f32m4(sum_row + nrr * 2,
                                      __riscv_vfmacc_vv_f32m4(__riscv_vle32_v_f32m4(sum_row + nrr * 2, vl), __riscv_vfwcvt_f_x_v_f32m4(suml_32_2, vl),
                                                              __riscv_vfmul_vf_f32m4(vec_scales_32, static_cast<float>(a_ptr[b].d[2]), vl), vl),
                                      vl);
                __riscv_vse32_v_f32m4(sum_row + nrr * 3,
                                      __riscv_vfmacc_vv_f32m4(__riscv_vle32_v_f32m4(sum_row + nrr * 3, vl), __riscv_vfwcvt_f_x_v_f32m4(suml_32_3, vl),
                                                              __riscv_vfmul_vf_f32m4(vec_scales_32, static_cast<float>(a_ptr[b].d[3]), vl), vl),
                                      vl);
                __riscv_vse32_v_f32m4(sum_row + nrr * 4,
                                      __riscv_vfmacc_vv_f32m4(__riscv_vle32_v_f32m4(sum_row + nrr * 4, vl), __riscv_vfwcvt_f_x_v_f32m4(suml_32_4, vl),
                                                              __riscv_vfmul_vf_f32m4(vec_scales_32, static_cast<float>(a_ptr[b].d[4]), vl), vl),
                                      vl);
                __riscv_vse32_v_f32m4(sum_row + nrr * 5,
                                      __riscv_vfmacc_vv_f32m4(__riscv_vle32_v_f32m4(sum_row + nrr * 5, vl), __riscv_vfwcvt_f_x_v_f32m4(suml_32_5, vl),
                                                              __riscv_vfmul_vf_f32m4(vec_scales_32, static_cast<float>(a_ptr[b].d[5]), vl), vl),
                                      vl);
                __riscv_vse32_v_f32m4(sum_row + nrr * 6,
                                      __riscv_vfmacc_vv_f32m4(__riscv_vle32_v_f32m4(sum_row + nrr * 6, vl), __riscv_vfwcvt_f_x_v_f32m4(suml_32_6, vl),
                                                              __riscv_vfmul_vf_f32m4(vec_scales_32, static_cast<float>(a_ptr[b].d[6]), vl), vl),
                                      vl);
                __riscv_vse32_v_f32m4(sum_row + nrr * 7,
                                      __riscv_vfmacc_vv_f32m4(__riscv_vle32_v_f32m4(sum_row + nrr * 7, vl), __riscv_vfwcvt_f_x_v_f32m4(suml_32_7, vl),
                                                              __riscv_vfmul_vf_f32m4(vec_scales_32, static_cast<float>(a_ptr[b].d[7]), vl), vl),
                                      vl);
                __riscv_vse32_v_f32m4(sum_row + nrr * 8,
                                      __riscv_vfmacc_vv_f32m4(__riscv_vle32_v_f32m4(sum_row + nrr * 8, vl), __riscv_vfwcvt_f_x_v_f32m4(suml_32_8, vl),
                                                              __riscv_vfmul_vf_f32m4(vec_scales_32, static_cast<float>(a_ptr[b].d[8]), vl), vl),
                                      vl);
                __riscv_vse32_v_f32m4(sum_row + nrr * 9,
                                      __riscv_vfmacc_vv_f32m4(__riscv_vle32_v_f32m4(sum_row + nrr * 9, vl), __riscv_vfwcvt_f_x_v_f32m4(suml_32_9, vl),
                                                              __riscv_vfmul_vf_f32m4(vec_scales_32, static_cast<float>(a_ptr[b].d[9]), vl), vl),
                                      vl);
                __riscv_vse32_v_f32m4(sum_row + nrr * 10,
                                      __riscv_vfmacc_vv_f32m4(__riscv_vle32_v_f32m4(sum_row + nrr * 10, vl), __riscv_vfwcvt_f_x_v_f32m4(suml_32_10, vl),
                                                              __riscv_vfmul_vf_f32m4(vec_scales_32, static_cast<float>(a_ptr[b].d[10]), vl), vl),
                                      vl);
                __riscv_vse32_v_f32m4(sum_row + nrr * 11,
                                      __riscv_vfmacc_vv_f32m4(__riscv_vle32_v_f32m4(sum_row + nrr * 11, vl), __riscv_vfwcvt_f_x_v_f32m4(suml_32_11, vl),
                                                              __riscv_vfmul_vf_f32m4(vec_scales_32, static_cast<float>(a_ptr[b].d[11]), vl), vl),
                                      vl);
            }
