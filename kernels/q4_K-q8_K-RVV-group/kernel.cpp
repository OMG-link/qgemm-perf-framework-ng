        ...
        for (int64_t x = 0; x < nc / 32; x++) { // N
            ...
            for (int64_t b = 0; b < nb; b++) { // K
                ...
                for (int sb = 0; sb < QK_K / 64; sb++) { // QK_K / 64=4,一次处理src0的64列  //
                    ...
                    asm volatile("" : : "vr"(suml_32_0), "vr"(suml_32_1), "vr"(suml_32_2), "vr"(suml_32_3), "vr"(suml_64_0), "vr"(suml_64_1), "vr"(suml_64_2), "vr"(suml_64_3));
                ...
                vfloat32m4_t src0_d = __riscv_vfwcvt_f_f_v_f32m4(__riscv_vle16_v_f16m2(b_ptr[b].d, vl), vl);
                vfloat32m4_t src0_dmin = __riscv_vfwcvt_f_f_v_f32m4(__riscv_vle16_v_f16m2(b_ptr[b].dmin, vl), vl);
