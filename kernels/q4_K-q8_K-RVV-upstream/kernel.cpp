// Copied from llama.cpp commit 314e729347defd9851e857f78084160c5786a7d8,
// ggml/src/ggml-cpu/arch/riscv/quants.c. See provenance.md and LICENSE.
// Only C-to-C++ compatibility changes were made.
#include "ggml.h"
...
void ggml_vec_dot_q4_K_q8_K(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc) {
    ...
    const auto * GGML_RESTRICT x = static_cast<const block_q4_K *>(vx);
    ...
    *s = sumf;
    ...
    case 128:
        for (int i = 0; i < nb; ++i) {
            ...
            float ftmp, ft2;
            const uint8_t * GGML_RESTRICT q40;
            const uint8_t * GGML_RESTRICT q41;
            const uint8_t * GGML_RESTRICT q42;
            const uint8_t * GGML_RESTRICT q43;
            const int8_t  * GGML_RESTRICT q80;
            const int8_t  * GGML_RESTRICT q81;
            const int8_t  * GGML_RESTRICT q82;
            const int8_t  * GGML_RESTRICT q83;
            int s0, s1, s2, s3;
